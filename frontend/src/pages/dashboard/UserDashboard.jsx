  ...
  return (
    <div className="flex h-screen  overflow-hidden">
      ...
      <main className="flex-1 p-6 overflow-y-auto bg-gray-400">
        ...
        <h2 className="text-lg font-bold mb-4">Total Tasks: {taskListCount}</h2>
        ...
        {isLoading ? (
          ...
          <div className="grid gap-4 ">
            {task?.map((t) => (
              <div key={t._id}>
                <Link to={`${t?._id}`}>
                  <div className="bg-white shadow rounded p-4 flex  justify-between items-center hover:bg-gray-50 transition">
                    <div>
